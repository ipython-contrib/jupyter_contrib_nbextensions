define([
    ...
    Planner.prototype.create_main_body = function () {
        ...
        const text_area = $('<div/>').attr('id', 'text_area').attr('contentEditable', 'true').attr('spellcheck', 'true');
    ...
    Planner.prototype.create_toolbar = function () {
        ...
        const upload_button = $('<a/>').attr('type', 'file').append(upload_icon);
        const upload_file = $('<input/>').attr('id', 'upload_file').attr('type', 'file');
