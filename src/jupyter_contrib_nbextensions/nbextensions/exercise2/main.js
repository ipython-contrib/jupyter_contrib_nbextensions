...
<div class=\"onoffswitch-switch\"  ></div> \
    ...
    function display_existing_sols_at_startup(){
        /**
    ...
    function load_ipython_extension() {
        ...
        if (Jupyter.notebook !== undefined && Jupyter.notebook._fully_loaded) {
            ...
            console.log("[exercise2] Notebook fully loaded -- exercise2 initialized ")
            display_existing_sols_at_startup()
        } else {
            console.log("[exercise2] Waiting for notebook availability")
            events.on("notebook_loaded.Notebook", function() {
                console.log("[exercise2]exercise2 initialized (via notebook_loaded)")
                display_existing_sols_at_startup()
            })
        }
