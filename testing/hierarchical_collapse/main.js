...
define([
...
], function(IPython, $, require, events, Notebook, TextCell) {
    "use strict";
    ...
    var bind_events = TextCell.TextCell.prototype.bind_events;
    TextCell.TextCell.prototype.bind_events = function () {
     ...
     */
    Notebook.Notebook.prototype.insert_cell_below = function (type,index) {
     ...
     */
    Notebook.Notebook.prototype.insert_cell_above = function (type,index) {
        index = this.index_or_selected(index);
        // check if the selected cell is collapsed
        // open first if a new cell is inserted
        var cell = this.get_cell(index);
    ...
    Notebook.Notebook.prototype.delete_single_cell = function (index) {
    ...
    Notebook.Notebook.prototype.flush_undelete_buffers = function () {
    ...
    Notebook.Notebook.prototype._insert_element_at_index = function(element, index){
     ...
     */
    TextCell.TextCell.prototype.set_level = function (level) {
    ...
    // extension.
    // Notebook.Notebook.prototype.to_code
    // Notebook.Notebook.prototype.to_markdown
    // Notebook.Notebook.prototype.to_raw
    ...
    var create_element = TextCell.TextCell.prototype.create_element;
    TextCell.TextCell.prototype.create_element = function () {
    ...
    var toggle_heading = function (cell) {
        ...
        if ( is_collapsed_heading(cell) ) {
			...
			cell.element.addClass('uncolla.psed_heading');
